...
export default function Home() {
  ...
  return (
    <main className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-background p-4 sm:p-6 lg:p-8">
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
        <Image 
          src="https://picsum.photos/seed/form/800/600"
          alt="Meeting"
          width={800}
          height={600}
          data-ai-hint="meeting form"
